    ...
    <div>
      ...
      <section className="hero">
        <div className="container">
          <img src="/assets/images/icons/dragon-icon.png" alt="QianLun Dragon" />
          ...
          <div className="grid grid-4">
            ...
            <div className="card">
              <div style={{position: 'relative'}}>
                ...
                <img src="/assets/images/products/watch.png" alt="Apex Chronograph Watch" />
              </div>
            ...
            <div className="card">
              <div style={{position: 'relative'}}>
                ...
                <img src="/assets/images/products/bag.png" alt="Sovereign Leather Bag" />
              </div>
              <div className="card-content">
                <span>👜 Bag</span>
            ...
            <div className="card">
              <div style={{position: 'relative'}}>
                ...
                <img src="/assets/images/products/shoes.png" alt="Imperial Oxford Shoes" />
              </div>
              <div className="card-content">
                <span>👞 Shoes</span>
            ...
            <div className="card">
              <div style={{position: 'relative'}}>
                ...
                <img src="/assets/images/products/wallet.png" alt="Elite Cardholder Wallet" />
              </div>
              <div className="card-content">
                <span>👛 Wallet</span>
          ...
          <div className="grid grid-3">
            ...
            <div className="card">
              <div className="card-content">
                ...
                <span style={{color: '#7f8c8d', fontSize: '0.9rem'}}>Collector</span>
              </div>
            </div>
            ...
            <div className="card">
              <div className="card-content">
                ...
                <h4>Sarah Chen</h4>
                <span style={{color: '#7f8c8d', fontSize: '0.9rem'}}>Fashion Influencer</span>
              </div>
            </div>
            ...
            <div className="card">
              <div className="card-content">
                ...
                <span style={{color: '#7f8c8d', fontSize: '0.9rem'}}>Business Owner</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section" style={{background: '#f8f9fa'}}>
        <div className="container text-center">
          <h3 style={{marginBottom: '16px'}}>Join the QianLun Inner Circle</h3>
          <p style={{marginBottom: '24px', color: '#7f8c8d'}}>Get early access to limited collections and exclusive offers</p>
          <div style={{maxWidth: '400px', margin: '0 auto'}}>
            <div style={{display: 'flex', gap: '8px'}}>
              <input
                type="email"
                placeholder="Enter your email"
                style={{flex: 1, padding: '12px 16px', border: '2px solid #ddd', borderRadius: '6px', fontSize: '16px'}}
              />
              <button onClick={handleSubscribe} className="btn btn-accent">Subscribe</button>
            </div>
          </div>
        </div>
      </section>
